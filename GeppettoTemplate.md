...
[since,before copy the code from html to grpejs if there is any commented line in this html will the commented line after copy the code.If we include the commented line it affects the template generation that is it will show some the value becomes null].
